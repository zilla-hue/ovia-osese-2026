  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center bg-stone-900 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-[1] bg-gradient-to-b from-stone-900/60 via-stone-900/20 to-stone-900/80" />

        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <p className="uppercase tracking-[0.35em] text-amber-400 text-sm md:text-base font-medium mb-5 animate-[fadeInDown_0.8s_ease-out]">
          ...
          <p className="text-xl md:text-2xl text-amber-300 font-serif mb-10">
            Welcome Home.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/programme"
              className="bg-amber-700 hover:bg-amber-600 text-white px-8 py-4 rounded-md text-lg font-medium transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-900/30"
            >
              View Programme
            </Link>
            <Link
            ...
            <Link
              to="/sponsors"
              className="bg-white/10 backdrop-blur-sm border border-amber-500/40 hover:bg-amber-600 hover:border-amber-600 text-amber-300 hover:text-white px-8 py-4 rounded-md text-lg font-medium transition-all duration-300 hover:-translate-y-0.5"
            >
              Become a Partner
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="bg-white flex items-center py-20 lg:py-28 px-6 sm:px-12 lg:px-16">
            <div className="max-w-lg mx-auto lg:mx-0 lg:ml-auto lg:mr-16">
              ...
              <p className="text-2xl md:text-3xl font-serif text-amber-800 mb-8 italic">
                It is a homecoming.
              </p>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-stone-700 leading-relaxed max-w-3xl mx-auto mt-6">
            ...
            <strong className="text-amber-800">lived</strong>.
          </p>
        </div>
      </section>
      ...
      <section className="relative h-80 md:h-[28rem] overflow-hidden">
        <img
          ...
          decoding="async"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-stone-900/70 via-stone-900/30 to-transparent flex items-center">
      ...
      <section className="py-24 bg-stone-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              to="/register"
              className="inline-block bg-amber-700 hover:bg-amber-600 text-white px-10 py-4 rounded-md text-lg font-medium transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-900/40"
            >
